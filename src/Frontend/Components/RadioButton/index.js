  ...
  _renderButton (obj, i) {
    return (
      <RadioButton
        ...
        labelStyleSelected={this.props.labelStyleSelected}
        style={this.props.radioStyle}
        animation={this.props.animation}
        isAnimationAll={this.props.isAnimationAll}
...
export class RadioButton extends React.Component {
  ...
  render () {
    ...
    testIDIndex = (this.props.testID && testIDIndex !== -1)
      ...
      <TouchableWithoutFeedback
        ...
        <View style={[
          ...
          <Text style={[
            ...
            this.props.labelStyle, this.props.isSelected && this.props.labelStyleSelected
